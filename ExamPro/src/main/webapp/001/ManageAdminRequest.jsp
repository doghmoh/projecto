...
<body>
    ...
    <section class="GlobalSection  bg-light">
                <h1 class="text-center mt-5" style="    font-size: 25px !important;font-weight: 900;">Admin Account</h1><hr>
            ...
            <tbody>
                 <x:forEach select="$output/Admins/Admin">
                <tr>
    ...
    <script>
        ...
        $("#deletebutton").click(function(){
            	    ...
            	    $.ajax({
            		  ...
            		  success: function() {
            		    window.location = "DisplayAdminRequest"
            		    
            		  },
            		  error: function(xhr) {
            		   console.log("Error........"+ xhr.status);
            		   window.location = "DisplayAdminRequest?msg=err"
            	      }
            		})
            	   };});
