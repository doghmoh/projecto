...
<body>
    ...
    <%@ include file = "./SideBarAdmin.jsp" %>
     ...
     <section class="GlobalSection  bg-light">
                <h1 class="text-center mt-5" style="    font-size: 25px !important;font-weight: 900;">Student Account</h1><hr>
            ...
            <table id="example" class="table table-striped pt-3 nowrap" style="width:100%;">
            <thead>
            ...
            <tbody>
                ...
                <tr>
                     <td><input type="checkbox" name="element"></td>
              	     ...
              	     <td><x:out select="Matricule"/></td>
              	     <td><x:out select="Departmentd"/></td>
              	     <td><x:out select="SpecialityId"/></td>
              	     <td><x:out select="LevelId"/></td>
              	     <td><x:out select="GroupId"/></td>
           		</tr>
                </x:forEach>
            </tbody>
        </table>
