...
<meta charset="ISO-8859-1">
	 ...
	 <form action="<%= request.getContextPath() %>/ProfServlet" method="post"> 
        <div class="row">
            <div class="form-sm-group "> 
             ...
             <div class="form-group "> 
               <input name="DateOfBirth" type="text" class="form-control" required placeholder="Date de Naissance" onfocus="type='date'" pattern="[A-Za-z]*" required/>
             </div>
